                                ...
                                <table class="table table-striped table-responsive" data-toggle="datatables">
                                    ...
                                    <tbody>
                                     ...
                                     <?php
                                            ...
                                            $product_data = $link->rawQuery("select * from product where product_active=1");
                                            if($link->count > 0)
                                            {
                                                foreach($product_data as $data)
                                                {
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="view_images.php?product_id=<?php echo $data['product_id']; ?>">
