                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">New Testimonial</h5>
                                <p class="text-muted">Add new testimonial details inside form</p>
                                <form name="add_test" id="add_test" method="POST" enctype="multipart/form-data" action="add_testcode.php">
                                    <div class="form-group">
                                        <label class="form-control-label">Testimonial Name</label>
                                        <input class="form-control" type="text" name="testname" id="testname">
                                    </div>

                                    <label for="blog_description">Testimonial Description</label>
                                     <div class="form-group">
                                        <textarea class="form-control" id="test_description" name="test_description" rows="13"></textarea>
                                    </div>
                                    ...
                                    <div data-toggle="dropzone" data-plugin-options="{&quot;url&quot;:&quot;assets/demo&quot;}">
                                        <div class="fallback">
                                            ...
                                            <input type="file" class="form-control" name="testimg" id="testimg" multiple="multiple">
                                        </div>
                                        <!-- /.fallback -->
                                    </div>
