        ...
        <main class="main-wrapper clearfix">
           ...
           <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h5 class="mr-0 mr-r-5">Testimonials Table</h5>
                    <p class="mr-0 text-muted d-none d-md-inline-block">Testimonials Details</p>
                </div>
                <!-- /.page-title-left -->
              </div>
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-heading clearfix">
                                <h5>VRIHI Testimonials Data Table</h5>
                            </div>
                            <!-- /.widget-heading -->
                                ...
                                <table class="table table-striped table-responsive" data-toggle="datatables">
                                    ...
                                    <tbody>
                                     ...
                                     <?php
                                            ...
                                            $test_data = $link->rawQuery("select * from testimonial");
                                            if($link->count > 0)
                                            {
                                                foreach($test_data as $data)
                                                {
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><img src="../images/testimonial_image/<?php echo $data['test_image']; ?>  " height="250px" width="250px"></td>
                                                        
                                                            <td><a href="edit_test.php?test_id=<?php echo $data['test_id']; ?>">
                                                                <button class="btn"><i class="material-icons list-icon">edit</i></button>
                                                            </a>
                                                            </td>
                                                            <td><a href="delete_test.php?test_id=<?php echo $data['test_id']; ?>">
