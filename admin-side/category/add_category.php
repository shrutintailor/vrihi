                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">New Category</h5>
                                <p class="text-muted">Add new category details inside form</p>
                                <form name="addCategory" id="formsubmit" method="POST" enctype="multipart/form-data" action="add_categorycode.php">
                                    <div class="form-group">
                                        <label class="form-control-label">Category Name</label>
                                        <input class="form-control" type="text" placeholder="Name of new category" name="categoryName" id="categoryName">
                                    </div>

                                    <div data-toggle="dropzone" data-plugin-options="{&quot;url&quot;:&quot;assets/demo&quot;}">
                                        <div class="fallback">
                                            <label class="form-control-label">Select Category Image</label>
                                            <input type="file" class="form-control" name="catImg" id="catImg" multiple="multiple">
                                        </div>
                                        <!-- /.fallback -->
                                    </div>
