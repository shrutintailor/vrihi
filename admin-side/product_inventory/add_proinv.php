                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">Add Product-Inventory</h5>
                                <p class="text-muted">Add new Product-Inventory details inside form</p>


                                <form name="addProductInv" id="addProductInv" method="POST" enctype="multipart/form-data" action="add_proinvcode.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="inventory" id="inventory">
                                            ...
                                            <?php
                                                ...
                                                $data = $link->rawQuery("select * from inventory where is_active=1");
                                                ...
                                                if($link->count>0)
                                                {
                                                    foreach($data as $inventory_data)
                                                    {
                                                        ...
                                                        ?>
                                                            ...
                                                            <option value="<?php echo $inventory_id; ?>"><?php echo $inventory_name; ?></option>
                                                ...
                                                {
                                                    $error = "No active inventory available";
                                                    ?>
