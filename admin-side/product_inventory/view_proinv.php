        ...
        <main class="main-wrapper clearfix">
           ...
           <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h5 class="mr-0 mr-r-5">Product-Inventory Table</h5>
                    <p class="mr-0 text-muted d-none d-md-inline-block">Product-Inventory Details</p>
                </div>
                <!-- /.page-title-left -->
              </div>
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-heading clearfix">
                                <h5>VRIHI Product-Inventory Data Table</h5>
                            </div>
                            <!-- /.widget-heading -->
                                ...
                                <table class="table table-striped table-responsive" data-toggle="datatables">
                                    ...
                                    <tbody>
                                     ...
                                     <?php
                                            ...
                                            $proinv_data = $link->rawQuery("select * from product_inventory");
                                            if($link->count > 0)
                                            {
                                                foreach($proinv_data as $data)
                                                {
                                                    ?>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                $proinv_pname = $link->rawQueryOne("select * from product where product_id=?",array($data['product_id']));

                                                                echo $proinv_pname['product_name'];

                                                                ?>
                                                            </td>
                                                            <td><?php  

                                                                $proinv_iname = $link->rawQueryOne("select * from inventory where inventory_id=?",array($data['inventory_id']));

                                                                echo $proinv_iname['inventory_name'];

                                                                ?></td>

                                                            <td><?php echo $data['product_inventory_price']; ?></td>

                                                        
                                                            <td><a href="edit_proinv.php?product_inventory_id=<?php echo $data['product_inventory_id']; ?>">
                                                                <button class="btn"><i class="material-icons list-icon">edit</i></button>
                                                            </a>
                                                            </td>
                                                            <td><a href="delete_proinv.php?product_inventory_id=<?php echo $data['product_inventory_id']; ?>">
