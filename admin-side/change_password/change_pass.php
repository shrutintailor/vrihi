                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <form name="chPass" id="chPass" method="POST" enctype="multipart/form-data" action="change_passcode.php">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="password" name="cnewpass" id="cnewpass">
                                    </div>
            ...
            $( "#chPass" ).validate( {
                ...
                messages: {
                    oldpass:
                    {
                        ...
                        maxlength: "Password Can Have 8 Characters Max *",
                    },
                    newpass:
                    {
