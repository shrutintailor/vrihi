                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                ...
                                <form name="addProduct" id="addProduct" method="POST" enctype="multipart/form-data" action="add_productcode.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="product_sd" id="product_sd">
                                    </div>

                                    <div class="form-group">
                                        <label class="form-control-label">Long Description</label>
                                        <textarea class="form-control" id="product_ld" name="product_ld" rows="12"></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label class="form-control-label">Product Quantity</label>
                                        <input class="form-control" type="number" name="product_qty" id="product_qty">
                                    </div>
