                                ...
                                <table class="table table-striped table-responsive" data-toggle="datatables">
                                    ...
                                    <tbody>
                                     ...
                                     <?php
                                            ...
                                            $blog_data = $link->rawQuery("select * from blogs");
                                            if($link->count > 0)
                                            {
                                                foreach($blog_data as $data)
                                                {
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $data['blog_author']; ?></td>
                                                            <td><img src="../images/blogs_img/<?php echo $data['blog_image']; ?>  " height="200px" width="200px"></td>

                                                             <td>
                                                                <?php if($data['is_hiden'] == 1)
                                                                        {
                                                                              ?>      

                                                                                 <a href="show_blog.php?blog_id=<?php echo $data['blog_id']; ?>">
                                                                                ...
                                                                                ?>
                                                                                 ...
                                                                                 <a href="hide_blog.php?blog_id=<?php echo $data['blog_id']; ?>">
                                                            ...
                                                            <td><a href="edit_blog.php?blog_id=<?php echo $data['blog_id']; ?>">
                                                                <button class="btn"><i class="material-icons list-icon">edit</i></button>
                                                            </a>
                                                            </td>
                                                            <td><a href="delete_blog.php?blog_id=<?php echo $data['blog_id']; ?>">
