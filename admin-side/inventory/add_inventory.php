                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">New Inventory</h5>
                                <p class="text-muted">Add new inventory details inside form</p>
                                <form name="addInventory" id="addInventory" method="POST" enctype="multipart/form-data" action="add_inventorycode.php">
                                    <div class="form-group">
                                        <label class="form-control-label">Inventory Name</label>
                                        <input class="form-control" type="text" placeholder="Name of new inventory" name="inventoryName" id="inventoryName">
                                    </div>
        ...
        $( document ).ready( function () {
            $( "#addInventory" ).validate( {
                ...
                messages: {
                    ...
                    inventoryName: "Please Enter Name of Inventory *",
