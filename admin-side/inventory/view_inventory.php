        ...
        <main class="main-wrapper clearfix">
           ...
           <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h5 class="mr-0 mr-r-5">Inventory Table</h5>
                    <p class="mr-0 text-muted d-none d-md-inline-block">Inventory Details</p>
                </div>
                <!-- /.page-title-left -->
              </div>
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-heading clearfix">
                                <h5>VRIHI Inventory Data Table</h5>
                            </div>
                            <!-- /.widget-heading -->
                                ...
                                <table class="table table-striped table-responsive" data-toggle="datatables">
                                    ...
                                    <tbody>
                                     ...
                                     <?php
                                            ...
                                            $Inventory_data = $link->rawQuery("select * from inventory");
                                            if($link->count > 0)
                                            {
                                                foreach($Inventory_data as $data)
                                                {
                                                    ?>
                                                        <tr>
                                                                ...
                                                                <?php if($data['is_active'] == 1)
                                                                        {
                                                                              ...
                                                                              <a href="disable_inventory.php?inventory_id=<?php echo $data['inventory_id']; ?>">
                                                                                ...
                                                                                <a href="activate_inventory.php?inventory_id=<?php echo $data['inventory_id']; ?>">
                                                            ...
                                                            <td><a href="edit_inventory.php?inventory_id=<?php echo $data['inventory_id']; ?>">
                                                                <button class="btn"><i class="material-icons list-icon">edit</i></button>
                                                            </a>
                                                            </td>
                                                            <td><a href="delete_inventory.php?inventory_id=<?php echo $data['inventory_id']; ?>">
