        ...
        <main class="main-wrapper clearfix">
           ...
           <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h5 class="mr-0 mr-r-5">Users Table</h5>
                    <p class="mr-0 text-muted d-none d-md-inline-block">Users Details</p>
                </div>
                <!-- /.page-title-left -->
              </div>
                                ...
                                <table class="table table-striped table-responsive" data-toggle="datatables">
                                    ...
                                    <tbody>
                                     ...
                                     <?php
                                            ...
                                            $user_data = $link->rawQuery("select * from users");
                                            if($link->count > 0)
                                            {
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $data['first_name'].$data['last_name']; ?></td>
                                                             ...
                                                             <td>
                                                               <?php echo $data['user_state']; ?>
                                                             </td>

                                                             <td>
                                                               <?php echo $data['user_city']; ?>
                                                             </td>
