        ...
        <main class="main-wrapper clearfix">
           ...
           <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h5 class="mr-0 mr-r-5">Inquiry Table</h5>
                    <p class="mr-0 text-muted d-none d-md-inline-block">Contact Details</p>
                </div>
                <!-- /.page-title-left -->
              </div>
                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-heading clearfix">
                                <h5>VRIHI Contact Data Table</h5>
                            </div>
                            <!-- /.widget-heading -->
                                ...
                                <table class="table table-striped table-responsive" data-toggle="datatables">
                                    ...
                                    <tbody>
                                     ...
                                     <?php
                                            ...
                                            $contact_data = $link->rawQuery("select * from contact");
                                            if($link->count > 0)
                                            {
