         ...
         <div class="content-offs-stick my-5 container">
            <div class="section-solid">
               <div class="z-index-4 position-relative">
                  ...
                  <div class="mt-3">
                     <div class="page-breadcrumbs"><a class="content-link" href="index.php">Home</a><span class="mx-2">\</span><span>Blog</span></div>
                  </div>
               </div>
            </div>
         </div>
                  ...
                  <div class="container">
                     <div class="grid row">
                        ...
                        $conn = mysqli_connect('localhost', 'root', '','dbvrihi');  
                         ...
                         $query = "select *from blogs where is_hiden=0";  
                         ...
                         $query = "SELECT *FROM blogs where is_hiden=0 LIMIT " . $page_first_result . ',' . $results_per_page;  
                         $result = mysqli_query($conn, $query);  
                        ...
                        <div class="col-lg-6 d-flex">
                           <article class="entity-block entity-hover-shadow entity-image-on-top text-center">
                              <a class="entity-preview-show-up entity-preview" href="blog_article.php?blog_id=<?php echo $row['blog_id']; ?>"><span class="embed-responsive embed-responsive-6by4"><img class="embed-responsive-item" src="admin-side/images/blogs_img/<?php echo $row['blog_image']; ?>" alt=""></span><span class="with-back entity-preview-content"><span class="overflow-back bg-body-back opacity-70"></span><span class="m-auto h1 text-theme text-center"><i class="fas fa-search"></i></span></span></a>
                              <div class="entity-content">
                                 <h4 class="entity-title"><a class="content-link" href="blog_article.php?blog_id=<?php echo $row['blog_id']; ?>"><?php echo $row['blog_title'] ?></a></h4>
                                 <div class="entity-date text-theme mb-3"><?php echo $row['blog_date'] ?></div>
                                 <p>Author: <?php echo $row['blog_author'] ?></p><br>
                                 <div class="mt-auto entity-action-btns"><a class="btn btn-theme" href="blog_article.php?blog_id=<?php echo $row['blog_id']; ?>">read blog</a></div>
                              </div>
                           </article>
                        </div>
                        <?php
                     ...
                     <div class="paginator">
                        ...
                        {  
                           ?>
                             ...
                             <a href = "blog_home.php?page=<?php echo $page ?>"><?php echo $page ?>&nbsp;&nbsp;</a> 
               ...
               <section class="section-sidebar">
                  ...
                  <ul class="list-unstyled">
                     <?php
                        ...
                        $sql = $link->rawQuery("select * from blogs group by blog_category");

                        if($link->count>0)
                        {
                           foreach($sql as $cat_data)
                           {
                     ?>
                     <li><a class="record-line" href="category_blogs.php?blog_category=<?php echo $cat_data['blog_category']; ?>"><span class="record-icon"><i class="fas fa-apple-alt"></i></span><span class="record-title"><?php echo $cat_data['blog_category'] ?></span></a></li>
                     <?php
                           }
                        }
                     ?>
