         ...
         <div class="content-offs-stick my-5 container">
            <div class="section-solid">
               <div class="z-index-4 position-relative">
                  <h1 class="section-title">User security</h1>
                  <div class="mt-3">
                     <div class="page-breadcrumbs"><a class="content-link" href="index.php">Home</a><span class="mx-2">\</span><span>User security</span></div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="section mb-0 container text-center">
         <nav class="line-navbar">
            <ul class="nav">
               ...
               <li class="nav-item"><a class="nav-link active" href="user_security.php">Security</a></li>
            </ul>
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12 col-md-10 col-lg-7 mx-auto">
                  <form name="security" id="security" method="POST" action="changepass.php">
                     <h2 class="section-title text-center my-5">Account security</h2>
                     <div class="row grid">
                        <div class="col-sm-6">
                           <div class="input-view-flat input-gray-shadow form-group">
                              <label class="required">Password</label>
                              <div class="input-group"><input class="form-control" name="password" id="password" type="password" placeholder="Password"></div>
                           </div>
                        </div>
                        <div class="col-sm-6">
                           <div class="input-view-flat input-gray-shadow form-group">
                              <label class="required">Confirm password</label>
                              <div class="input-group"><input class="form-control" name="confirmPassword" id="confirmPassword" type="password" placeholder="Confirm password"></div>
                           </div>
                        </div>
                        <?php
                          ...
                          {
                              ?>
                                  <div><p style="color:red;">Something went wrong!Try again.</p></div>
                              <?php
                          }
                        ?>
                     </div>
